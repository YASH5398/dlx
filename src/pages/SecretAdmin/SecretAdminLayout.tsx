  ...
  return (
    <AdminSocketProvider>
        ...
        <Dialog as="div" className="relative z-50 md:hidden" onClose={() => setMobileOpen(false)}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-start justify-start">
              ...
              >
                <Dialog.Panel className="w-full max-w-sm sm:w-80 h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-r border-gray-700/50 shadow-2xl backdrop-blur-xl">
      ...
      <div className="flex-1 flex flex-col">
        {/* Topbar - Enhanced Mobile Responsiveness */}
        <header className="sticky top-0 z-40 h-14 sm:h-16 bg-gradient-to-r from-gray-900 to-gray-850 border-b border-gray-800/50 flex items-center justify-between px-3 sm:px-4 md:px-6 shadow-sm backdrop-blur-sm">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
            <button
              className="md:hidden inline-flex items-center justify-center rounded-lg p-2 bg-gray-800/50 hover:bg-gray-700/50 transition-all duration-200 flex-shrink-0"
            ...
            <button
              className="hidden md:inline-flex items-center justify-center rounded-lg p-2 bg-gray-800/50 hover:bg-gray-700/50 transition-all duration-200 flex-shrink-0"
              onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
            >
              <Bars3Icon className="w-5 h-5 text-gray-300" />
            </button>
            
            <div className="text-base sm:text-lg font-semibold text-gray-200 truncate">Admin Panel</div>
          </div>
          
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4 flex-shrink-0">
            {/* Notifications */}
            <button className="relative p-1.5 sm:p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 transition-all duration-200">
              <BellIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" />
              {notifications > 0 && (
            ...
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 transition-all duration-200"
            >
              {darkMode ? (
                <SunIcon className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400" />
              ) : (
                <MoonIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" />
              )}
            </button>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                onClick={logout}
                className="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg bg-red-600/80 hover:bg-red-700 text-white text-xs sm:text-sm font-medium transition-all duration-200 flex items-center gap-1 sm:gap-2"
              >
