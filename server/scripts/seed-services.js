...
const services = [
  ...
  // AI Agents & Automation
  {
    ...
    rating: 4.8,
    category: 'Crypto',
    description: 'Automated token launchpad agent that handles presale setup, whitelisting, and distribution.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1621509341960-6f5028a7891d?q=80&w=1200&auto=format&fit=crop',
  },
  {
    title: 'Auto Voiceover Video Agent',
    price: '$299 / ₹24,900',
    price_usd: 299,
    price_inr: 24900,
    commission: 20,
    rating: 4.8,
    category: 'AI & Automation',
    description: 'AI-powered agent that automatically generates professional voiceovers for videos with multiple language options.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1598550476439-6847785fcea6?q=80&w=1200&auto=format&fit=crop',
  },
  {
    title: 'Auto Email Campaign Agent',
    price: '$199 / ₹16,500',
    price_usd: 199,
    price_inr: 16500,
    commission: 20,
    rating: 4.8,
    category: 'AI & Automation',
    description: 'Intelligent email campaign agent that creates, schedules, and optimizes email sequences automatically.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?q=80&w=1200&auto=format&fit=crop',
  },
  {
    ...
    rating: 4.8,
    category: 'Crypto',
    description: 'Automated copy trading agent that mirrors successful traders\' strategies with risk management controls.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop',
  },
  {
    title: 'Whale Tracker Agent',
    price: '$399 / ₹33,000',
    price_usd: 399,
    price_inr: 33000,
    commission: 20,
    rating: 4.8,
    category: 'Crypto',
    description: 'Real-time agent that tracks large wallet movements and provides alerts on whale transactions.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=1200&auto=format&fit=crop',
  },
  {
    title: 'Exchange Arbitrage Agent',
    price: '$799 / ₹66,300',
    price_usd: 799,
    price_inr: 66300,
    commission: 20,
    rating: 4.8,
    category: 'Crypto',
    description: 'Automated arbitrage agent that identifies and executes profitable trades across multiple exchanges.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1200&auto=format&fit=crop',
  },
  {
    title: 'Auto Trading Signal Agent',
    price: '$499 / ₹41,500',
    price_usd: 499,
    price_inr: 41500,
    commission: 20,
    rating: 4.8,
    category: 'Crypto',
    description: 'AI-powered trading signal agent that analyzes markets and sends automated buy/sell alerts.',
    thumbnailUrl: 'https://images.unsplash.com/photo-1641932397724-6f0ca6e69a34?q=80&w=1200&auto=format&fit=crop',
  },
  {
    ...
    rating: 4.8,
    category: 'AI & Automation',
    description: 'Fully automated YouTube agent that handles video optimization, SEO, scheduling, and analytics.',
